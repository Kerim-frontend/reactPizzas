            ...
            {totalCount ? (
                <div className="cart">
                    ...
                    <div className="content__items">
                        {addedPizzas.map(obj => <CartItem name={obj.name} id={obj.id} type={obj.type} img={obj.imageUrl} size={obj.size} totalPrice={items[obj.id].totalPrice} totalCount={items[obj.id].items.length} onRemoveItem={onRemoveItem} onPlus={onPilusCart} onMinus={onMinusCart}/>)}
                    </div>
